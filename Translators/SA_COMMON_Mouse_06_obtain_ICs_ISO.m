% This file obtains the initial conditions with ISO.
...
prot_freq = 6.2; % [Hz] CHANGE DEPENDING ON FREQUENCY
...
%% Run cycle
all_ICs_ISO = all_ICs*0;

tic
parfor ii = 1:N_trials
%for ii = 1:10 % plot figure
...
%% Saving
%save ICs_matrix_1500_0p1_60s_ISO_mouse_COMMON_6p2Hz all_ICs   
