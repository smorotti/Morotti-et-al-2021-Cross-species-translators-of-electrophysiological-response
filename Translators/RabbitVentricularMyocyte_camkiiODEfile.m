function dydt = RabbitVentricularMyocyte_camkiiODEfile(t,y,p)
...
LCC_PKAp = y(1); % [LCCp] by PKA (currently unused anywhere else)
LCC_CKdyadp = y(2); % Dyadic [LCCp] by dyadic CaMKII
RyR2809p = y(3); % [RyR-Ser2809p] by PKA (currently unused anywhere else)
RyR2815p = y(4); % [RyR-Ser2815p] by CaMKII 
PLBT17p = y(5); % [PLB-Thr17p] by CaMKII
LCC_CKslp = y(6); % Subsarcolemmal [LCCp] by subsarcolemmal CaMKII
%% Parameters
