...
load ICs_matrix_1500_0p1_300s_mouse_COMMON_4p8Hz
...
prot_freq = 4.8; % [Hz] CHANGE DEPENDING ON FREQUENCY
...
tspan = [0 10*prot_cycleLength]; % [ms]
...
%% Saving
%save outputs_matrix_1500_0p1_300s_mouse_COMMON_4p8Hz all_outputs output_names output_units
