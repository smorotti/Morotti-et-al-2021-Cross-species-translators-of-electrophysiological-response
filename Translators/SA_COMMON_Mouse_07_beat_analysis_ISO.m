...
load ICs_matrix_1500_0p1_60s_ISO_mouse_COMMON_6p2Hz
...
tspan = [0 13*prot_cycleLength]; % [ms]
...
%% Saving
%save outputs_matrix_1500_0p1_60s_ISO_mouse_COMMON_6p2Hz all_outputs output_names output_units
