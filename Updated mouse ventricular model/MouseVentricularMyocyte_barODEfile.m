function ydot = MouseVentricularMyocyte_barODEfile(t,y,pin)
...
db1AR_S464 = bARK_desens - bARK_resens; % ydot
db1AR_S301 = PKA_desens - PKA_resens; % ydot

G_act = k_G_act*(RG+LRG);
G_hyd = k_G_hyd*GsaGTPtot;
G_reassoc = k_G_reassoc*GsaGDP*Gsby;
dGsaGTPtot = G_act - G_hyd; % ydot
dGsaGDP = G_hyd - G_reassoc; % ydot
dGsby = G_act - G_reassoc; % ydot
% end b-AR module
%% cAMP module
...
dcAMPtot = AC_ACT_BASAL + AC_ACT_GSA + AC_ACT_FSK - PDE_ACT; % ydot
% end cAMP module
%% PKA module
...
dTnIp = TnI_phosph - TnI_dephosph; % ydot
% end TnI module
%% Myofilament module
...
%% Ikur module (adjusted kinetics as in Xie et al 2013, see Wang et al 2019)
...
%k_pka_KUR = 54e-3; % k_pka_KUR    [1/ms] % J Physiol 2014 version
    k_pka_KUR = 1.87e-3; % 54e-3; % k_pka_KUR    [1/ms] % adjusted as in Xie et al 2013
Km_pka_KUR = 21; % p(99) = 21;    % Km_pka_KUR   [uM]
%k_pp1_KUR = 8.52e-3; % k_pp1_KUR    [1/ms] % J Physiol 2014 version
    k_pp1_KUR = 0.19e-3; % 8.52e-3; % k_pp1_KUR    [1/ms] % adjusted as in Xie et al 2013
...
dKURp = KURphos - KURdephos; % ydot
% end Ikur module
%% Ito module (from IKr)

Totot = pin(10);        % Itotot_bar    [uM]
