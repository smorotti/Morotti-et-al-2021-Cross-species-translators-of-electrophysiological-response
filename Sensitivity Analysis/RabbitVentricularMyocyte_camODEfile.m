function dydt = RabbitVentricularMyocyte_camODEfile(t,y,params)
...
CaM = y(1); % Ca-free CaM
Ca2CaM = y(2); % 2 Ca bound to C terminal sites
Ca4CaM = y(3); % 4 Ca bound
CaMB = y(4);
Ca2CaMB = y(5);
Ca4CaMB = y(6);
Pb2 = y(7); % probability of a Ca2CaM bound CaMKII subunit
Pb = y(8); % probability of a Ca4CaM bound CaMKII subunit
Pt = y(9); % probability of a Ca4CaM bound autophosphorylated CaMKII subunit
Pt2 = y(10); % probability of a Ca2CaM bound autophosphorylated CaMKII subunit
Pa = y(11); % probability of an autonomous autophosphorylated CaMKII subunit
Ca4CaN = y(12);
CaMCa4CaN = y(13);
Ca2CaMCa4CaN = y(14);
Ca4CaMCa4CaN = y(15); % active calcineurin
%% Parameters
